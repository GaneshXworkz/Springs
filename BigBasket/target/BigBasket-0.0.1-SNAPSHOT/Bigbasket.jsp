...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
   ...
   <form action="bigBasket" method="post" class="container col-12 col-sm-6 col-md-3 shadow-lg p-4 mb-4 bg-white mx-auto d-block border border-primary rounded-lg 
m-5 pb-5 bg-info"> 
