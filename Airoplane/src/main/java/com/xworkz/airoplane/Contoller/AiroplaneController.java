...
public class AiroplaneController {
	...
	private List<String> type = Arrays.asList("Jet", "CarAiroplane", "Mailtry", "DroneCraft", "JamerPlan");
	private List<String> country = Arrays.asList("America", "Russia", "India", "SriLanka", "Germeny", "Cannada");
	...
	public String getSearch(@RequestParam int id, Model model) {
		...
		if (vDto != null) {
			...
			model.addAttribute("message", "Id is not found");
		}
		return "feachById";
	}
